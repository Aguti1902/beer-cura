      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-8 md:mb-10">
          ...
          <p className="mt-2 text-honey-100 text-sm md:text-base">
            <BeecuraMark className="text-white font-semibold" /> de Aire de Colmena
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
          {dolenciasAdC.map((item, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl px-4 py-5 md:py-6 text-center shadow-lg border border-honey-200/50"
            >
